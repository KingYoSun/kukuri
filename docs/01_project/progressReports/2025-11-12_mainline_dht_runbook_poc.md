...
- `design_doc.md` / `docs/01_project/deprecated/refactoring_plan_2025-08-08_v3.md` / `tasks/completed/2025-11-12.md` を更新し、Mainline DHT Runbook の完了を Phase5 ステータスに反映。今後のフォーカスを EventGateway 実装へ切り替えた。
...
- `design_doc.md` Phase5 行と `docs/01_project/deprecated/refactoring_plan_2025-08-08_v3.md` の P2P/EventGateway 行を Runbook 完了ベースに更新し、残タスクが EventGateway 実装と `trending_metrics_job` カバレッジであることを明示。
