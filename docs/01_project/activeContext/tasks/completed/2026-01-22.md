...
- [x] KIP-0001 Access Control（39020/39021、join/redeem、epochローテ/追放）の v1 方針を整理し、User API / relay / Admin Console 設計へ反映。
...
- `docs/03_implementation/community_nodes/kukuri_cli_migration.md`
