...
- [x] Docker Test Suite �� `-D warnings` �Œ�~���Ă������߁A���g�p���W���[�� (`memory_cache` �Ȃ�) �ƃv���[���e�[�V�����w�̖��z���n���h��/DTO �𐮗����A�e�X�g��p���\�b�h�� `#[cfg(test)]` �Ɉڂ��Ė{�ԃr���h���珜�O�����B
- [x] �v���t�B�[���A�o�^�[���L�`�P�b�g�� kind:30078 ���^�f�[�^�ADHT/Gossip/Distributor ��ԂȂǕێ����Ă��邾���������t�B�[���h�Ɏ����p�i�o���f�[�V�����E���O�E�폜�j��ǉ����� Rust ���� dead_code �����������B
- [x] `ApiResponse`�E`AuthHandler`�E`state.rs` �Ȃ� AppState ���ӂ����V���ACI �� Docker �W���u�ł� clean build �ɂȂ邱�Ƃ� `gh act` �Ŋm�F�����B
...
- `kukuri-tauri/src-tauri/src/state.rs` �Ȃ� dead_code �C���ōX�V���� Rust �t�@�C���ꎮ
