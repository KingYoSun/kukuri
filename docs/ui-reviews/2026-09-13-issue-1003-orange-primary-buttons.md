...
- Superseded by: None
- PR: Issue #1003対応PR（リンクと最終CI結果は作業記録へ集約）。
- Preview: [Windows dark](assets/1003/windows-v2-dark.jpg)。Linux／Chromiumの同条件before／afterはPRのvisual baseline差分で確認できる。
...
- Validation / Not verified / Review result: ユーザーがv2の変更を指定済み。対象browser 7件、styles contract 125件が成功。必須全体UI検証と最終CIを継続中。現在結果は[作業記録](../progress/2026-09-13-1003-orange-primary-buttons.md)を参照。
