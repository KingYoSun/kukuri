...
- version 7（2026-09-18）: Community Node の送信契機に「信頼評価の照会」を追加しました。採用順位に選んだ Node へ、表示した投稿と引用元の作成者の公開鍵を送ります。本文・閲覧履歴・ブロック / ミュートの一覧は送りません（#1061）。
