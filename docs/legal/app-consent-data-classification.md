...
- version 7 は、利用規約 第3条に信頼評価による折りたたみ（第 5 項）とブロック・ミュートの任意提供（第 6 項）を追加し、プライバシーポリシーと外部送信表示へ信頼評価の照会とブロック・ミュートの提供で送る項目・送らない情報・取消時の削除要求を追記する重要変更である(#1061、ADR 0026 §8)。
