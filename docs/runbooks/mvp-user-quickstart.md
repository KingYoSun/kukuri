...
6. 同じトピック内でプライベートチャンネルを作るか参加する。入口はタイムラインカラム上部の「プライベートチャンネル」ボタン、または「コントロールセンター → 場所 → プライベートチャンネル作成・参加」。招待・共有リンクは、参加後にタイムラインカラム上部の「設定と共有」（またはコントロールセンターのチャンネル設定）から作成する。
