...
const PubSubDiscoveryTopic string = "kukuri-browser-peer-discovery"

const ChatTopic string = "kukuri-chat/main"
const ChatFileTopic string = "kukuri-file"
...
func (cr *ChatRoom) requestFile(toPeer peer.ID, fileID []byte) ([]byte, error) {
	stream, err := cr.h.NewStream(context.Background(), toPeer, "/kukuri-file/1")
	if err != nil {
