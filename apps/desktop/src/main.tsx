...
if (import.meta.env.VITE_KUKURI_DESKTOP_MOCK === '1') {
  installWindowDesktopMock({
    seedPosts: {
      ...
      'kukuri:topic:iroh': [
        {
          object_id: 'browser-iroh-post',
          envelope_id: 'browser-iroh-envelope',
          author_pubkey: 'c'.repeat(64),
          author_name: 'iroh builder',
          author_display_name: 'iroh builder',
          following: false,
          followed_by: false,
          mutual: false,
          friend_of_friend: false,
          object_kind: 'post',
          content: 'iroh topic seed for builder preview',
          content_status: 'Available',
          attachments: [],
          created_at: 3,
          reply_to: null,
          root_id: 'browser-iroh-post',
          audience_label: 'Public',
        },
      ],
      'kukuri:topic:nostr': [
        {
          object_id: 'browser-nostr-post',
          envelope_id: 'browser-nostr-envelope',
          author_pubkey: 'd'.repeat(64),
          author_name: 'nostr builder',
          author_display_name: 'nostr builder',
          following: false,
          followed_by: false,
          mutual: false,
          friend_of_friend: false,
          object_kind: 'post',
          content: 'nostr topic seed for builder preview',
          content_status: 'Available',
          attachments: [],
          created_at: 4,
          reply_to: null,
          root_id: 'browser-nostr-post',
          audience_label: 'Public',
        },
      ],
      'kukuri:topic:operators': [
        {
          object_id: 'browser-operators-post',
          envelope_id: 'browser-operators-envelope',
          author_pubkey: 'e'.repeat(64),
          author_name: 'node operator',
          author_display_name: 'node operator',
          following: false,
          followed_by: false,
          mutual: false,
          friend_of_friend: false,
          object_kind: 'post',
          content: 'operators topic seed for builder preview',
          content_status: 'Available',
          attachments: [],
          created_at: 5,
          reply_to: null,
          root_id: 'browser-operators-post',
          audience_label: 'Public',
        },
      ],
    },
