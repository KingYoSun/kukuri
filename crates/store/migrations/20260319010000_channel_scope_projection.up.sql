ALTER TABLE object_index_cache
    ADD COLUMN channel_id TEXT NOT NULL DEFAULT 'public';
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_live_presence_cache_identity
    ON live_presence_cache(topic_id, channel_id, session_id, author_pubkey);
