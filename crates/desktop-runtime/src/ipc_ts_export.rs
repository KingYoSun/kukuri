...
fn export_ipc_types() {
    use crate::{
        ...
        CommitDomeLayoutRequest, CommunityNodeAdmissionRejection,
    ...
    use kukuri_core::{
        ...
        DomeLayoutCandidateV1, DomeLayoutCommitV1, DomeMaterialPreset, DomeMovePhaseV1,
        DomeMoveRecordV1, DomePhysicsBodyKindV1, DomePhysicsBodyV1, DomePhysicsSnapshotV1,
        DomePresetRefV1, DomeProposalDerivedStatusV1, DomeProposalSelectionV1,
        DomeRejectedConnectionV1, DomeRelationshipDetachV1, DomeSessionInputKindV1,
        DomeSurfaceCustomizationV1, DomeTopologyResolutionV1, DomeTopologyV1,
        FriendOnlyGrantPreview, FriendPlusSharePreview, GameRoomKind, GameRoomStatus,
        LiveSessionStatus, MetaverseAssetKind, MetaverseAssetRef, MetaverseColliderV1,
        ...
        MetaverseRoomPresenceV1, MetaverseRoomSpawnV1, MetaverseRoomStateV1,
