...
fn export_ipc_types() {
    ...
    use kukuri_core::{
        ...
        DomeComponentTopologyV1, DomeConnectionAgreementV1, DomeConnectionEndpointV1,
        DomeConnectionProposalV1, DomeConnectionRecordV1, DomeConnectionStatusV1,
        DomeConnectionTerminalReasonV1, DomeCustomizationV1, DomeDirection, DomeEnvironmentV1,
        DomeHostTargetV1, DomeHostingLeaseV1, DomeHostingStateKindV1, DomeHostingStateV1,
        DomeInstanceStatusV1, DomeLayoutCandidateV1, DomeLayoutCommitV1, DomeMaterialPreset,
        DomeMovePhaseV1, DomeMoveRecordV1, DomePhysicsBodyKindV1, DomePhysicsBodyV1,
        DomePhysicsSnapshotV1, DomePresetRefV1, DomeProposalDerivedStatusV1,
        ...
        DomeTopologyResolutionV1, DomeTopologyV1, FriendOnlyGrantPreview, FriendPlusSharePreview,
        GameRoomKind, GameRoomStatus, HostResourceBudget, LiveSessionStatus,
        MetaverseAssetBudgetMetadataV1, MetaverseAssetKind, MetaverseAssetRef,
