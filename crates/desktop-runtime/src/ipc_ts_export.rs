...
fn export_ipc_types() {
    ...
    use kukuri_core::{
        ...
        DomeDirection, DomeEnvironmentV1, DomeMaterialPreset, DomeSurfaceCustomizationV1,
        FriendOnlyGrantPreview, FriendPlusSharePreview, GameRoomKind, GameRoomStatus,
        LiveSessionStatus, MetaverseAssetKind, MetaverseAssetRef, MetaverseAvatarTransformV1,
        MetaverseColliderV1, MetaverseDomeV1, MetaverseInteractionKind, MetaversePersistentPropV1,
        MetaversePrimitive, MetaverseRoomChatMessageV1, MetaverseRoomEventEnvelopeContentV1,
        MetaverseRoomEventV1, MetaverseRoomPresenceV1, MetaverseRoomSpawnV1, MetaverseRoomStateV1,
