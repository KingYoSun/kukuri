...
fn export_ipc_types() {
    use crate::{
        ...
        BookmarkCustomReactionRequest, BookmarkPostRequest, CommunityNodeAdmissionRejection,
    ...
    use kukuri_core::{
        ...
        DomeCustomizationV1, DomeDirection, DomeEnvironmentV1, DomeInstanceStatusV1,
        DomeMaterialPreset, DomeMovePhaseV1, DomeMoveRecordV1, DomePresetRefV1,
        DomeProposalDerivedStatusV1, DomeProposalSelectionV1, DomeRejectedConnectionV1,
        DomeRelationshipDetachV1, DomeSurfaceCustomizationV1, DomeTopologyResolutionV1,
