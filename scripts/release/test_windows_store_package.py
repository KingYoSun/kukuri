...
class WindowsStorePackageContracts(unittest.TestCase):
    ...
    def test_packaging_keeps_store_and_local_test_signatures_separate(self):
        ...
        self.assertIn("Import-Certificate -FilePath $certificateOutputPath -CertStoreLocation Cert:\\CurrentUser\\Root", source)
        self.assertIn("certutil.exe -user -delstore Root $certificate.Thumbprint", source)
