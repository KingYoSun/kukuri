...
describe('MarkdownEditor', () => {
  ...
  it('displays placeholder text', () => {
    ...
    render(<MarkdownEditor value="" onChange={mockOnChange} placeholder={placeholder} />);
  ...
  it('respects maxLength constraint', async () => {
    const user = userEvent.setup();
    render(<MarkdownEditor value="Hello" onChange={mockOnChange} maxLength={10} />);
  ...
  it('hides toolbar when hideToolbar is true', () => {
    render(<MarkdownEditor value="" onChange={mockOnChange} hideToolbar={true} />);

    expect(screen.queryByTestId('toolbar')).not.toBeInTheDocument();
  });

  it('renders with custom height', () => {
    render(<MarkdownEditor value="" onChange={mockOnChange} height={500} />);
  ...
  it('handles image upload', () => {
    ...
    render(<MarkdownEditor value="" onChange={mockOnChange} onImageUpload={mockOnImageUpload} />);
