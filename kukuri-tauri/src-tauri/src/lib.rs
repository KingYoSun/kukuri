...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            presentation::commands::get_topic_timeline,
            ...
            presentation::commands::community_node_get_trust_provider,
            presentation::commands::community_node_set_trust_provider,
            presentation::commands::community_node_clear_trust_provider,
