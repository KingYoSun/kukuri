...
/// オフラインアクションを保存
#[tauri::command]
pub async fn save_offline_action_v2(
...
/// オフラインアクションを取得
#[tauri::command]
pub async fn get_offline_actions_v2(
    state: State<'_, AppState>,
...
/// オフラインアクションを同期
#[tauri::command]
pub async fn sync_offline_actions_v2(
    state: State<'_, AppState>,
...
/// キャッシュステータスを取得
#[tauri::command]
pub async fn get_cache_status_v2(
    state: State<'_, AppState>,
...
/// 同期キューに追加
#[tauri::command]
pub async fn add_to_sync_queue_v2(
    state: State<'_, AppState>,
...
/// キャッシュメタデータを更新
#[tauri::command]
pub async fn update_cache_metadata_v2(
    state: State<'_, AppState>,
...
/// 楽観的更新を保存
#[tauri::command]
pub async fn save_optimistic_update_v2(
    state: State<'_, AppState>,
    entity_type: String,
    entity_id: String,
...
/// 楽観的更新を確定
#[tauri::command]
pub async fn confirm_optimistic_update_v2(
    state: State<'_, AppState>,
    update_id: String,
) -> Result<String, String> {
    state
...
/// 楽観的更新をロールバック
#[tauri::command]
pub async fn rollback_optimistic_update_v2(
    state: State<'_, AppState>,
    update_id: String,
...
/// 期限切れキャッシュをクリーンアップ
#[tauri::command]
pub async fn cleanup_expired_cache_v2(
    state: State<'_, AppState>,
) -> Result<i32, String> {
    state
        .offline_handler
...
/// 同期ステータスを更新
#[tauri::command]
pub async fn update_sync_status_v2(
    state: State<'_, AppState>,
    entity_type: String,
    entity_id: String,
    sync_status: String,
