...
#[tauri::command]
pub async fn initialize_nostr_v2(state: State<'_, AppState>) -> Result<String, String> {
    state
        .event_handler
        .initialize_nostr()
        .await
...
/// テキストノートを投稿
#[tauri::command]
pub async fn publish_text_note_v2(
    content: String,
...
/// トピック投稿を作成
#[tauri::command]
pub async fn publish_topic_post_v2(
    topic_id: String,
    content: String,
...
/// メタデータを更新
#[tauri::command]
pub async fn update_nostr_metadata_v2(
...
/// トピックをサブスクライブ
#[tauri::command]
pub async fn subscribe_to_topic_v2(
    topic_id: String,
    state: State<'_, AppState>,
...
/// ユーザーをサブスクライブ
#[tauri::command]
pub async fn subscribe_to_user_v2(
    pubkey: String,
    state: State<'_, AppState>,
) -> Result<String, String> {
    state
...
/// Nostr公開鍵を取得
#[tauri::command]
pub async fn get_nostr_pubkey_v2(state: State<'_, AppState>) -> Result<String, String> {
    state
        .event_handler
        .get_nostr_pubkey()
        .await
...
/// Nostrクライアントを切断
#[tauri::command]
pub async fn disconnect_nostr_v2(state: State<'_, AppState>) -> Result<String, String> {
    state
        .event_handler
        .disconnect_nostr()
        .await
