...
use crate::domain::entities::{Post, Topic, User, Event, UserMetadata};
...
pub trait PostRepository: Send + Sync {
    ...
    async fn get_posts_by_topic(&self, topic_id: &str, limit: Option<u32>, offset: Option<u32>) -> Result<Vec<Post>, AppError>;
    async fn get_posts_by_author(&self, author_pubkey: &str, limit: Option<u32>, offset: Option<u32>) -> Result<Vec<Post>, AppError>;
...
pub trait TopicRepository: Send + Sync {
    ...
    async fn update_topic_stats(&self, topic_id: &str, member_count: u32, post_count: u32) -> Result<(), AppError>;
}
...
pub trait EventRepository: Send + Sync {
    ...
    async fn get_events_by_kind(&self, kind: u32, limit: Option<u32>) -> Result<Vec<Event>, AppError>;
    async fn get_events_by_author(&self, author_pubkey: &str, limit: Option<u32>) -> Result<Vec<Event>, AppError>;
